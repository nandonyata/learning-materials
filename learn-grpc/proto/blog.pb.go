...
const file_proto_blog_proto_rawDesc = "" +
	"\n" +
	"\x10proto/blog.proto\x12\x04blog\x1a\x1bgoogle/protobuf/empty.proto\"c\n" +
	"\x04Blog\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id\x12\x1b\n" +
	"\tauthor_id\x18\x02 \x01(\x05R\bauthorId\x12\x14\n" +
	"\x05title\x18\x03 \x01(\tR\x05title\x12\x18\n" +
	"\acontent\x18\x04 \x01(\tR\acontent\"\x18\n" +
	"\x06BlogId\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x05R\x02id2\xf7\x01\n" +
	"\vBlogService\x12&\n" +
	"\n" +
	"CreateBlog\x12\n" +
	".blog.Blog\x1a\f.blog.BlogId\x12&\n" +
	"\n" +
	"GetOneBlog\x12\f.blog.BlogId\x1a\n" +
	".blog.Blog\x120\n" +
	"\n" +
	"UpdateBlog\x12\n" +
...
var file_proto_blog_proto_depIdxs = []int32{
	...
	1, // 1: blog.BlogService.GetOneBlog:input_type -> blog.BlogId
	0, // 2: blog.BlogService.UpdateBlog:input_type -> blog.Blog
	1, // 3: blog.BlogService.DeleteBlog:input_type -> blog.BlogId
	2, // 4: blog.BlogService.GetAllBlog:input_type -> google.protobuf.Empty
	1, // 5: blog.BlogService.CreateBlog:output_type -> blog.BlogId
	0, // 6: blog.BlogService.GetOneBlog:output_type -> blog.Blog
	...
	0, // 9: blog.BlogService.GetAllBlog:output_type -> blog.Blog
