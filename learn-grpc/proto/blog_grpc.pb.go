...
const (
	...
	BlogService_GetOneBlog_FullMethodName = "/blog.BlogService/GetOneBlog"
	...
	BlogService_GetAllBlog_FullMethodName = "/blog.BlogService/GetAllBlog"
)
...
type BlogServiceClient interface {
	...
	GetAllBlog(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Blog], error)
}
...
func (c *blogServiceClient) GetOneBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*Blog, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Blog)
	err := c.cc.Invoke(ctx, BlogService_GetOneBlog_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *blogServiceClient) GetAllBlog(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Blog], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BlogService_ServiceDesc.Streams[0], BlogService_GetAllBlog_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
...
type BlogService_GetAllBlogClient = grpc.ServerStreamingClient[Blog]
...
type BlogServiceServer interface {
	...
	GetAllBlog(*emptypb.Empty, grpc.ServerStreamingServer[Blog]) error
...
func (UnimplementedBlogServiceServer) GetAllBlog(*emptypb.Empty, grpc.ServerStreamingServer[Blog]) error {
...
func _BlogService_GetOneBlog_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BlogService_GetOneBlog_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _BlogService_GetAllBlog_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(BlogServiceServer).GetAllBlog(m, &grpc.GenericServerStream[emptypb.Empty, Blog]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type BlogService_GetAllBlogServer = grpc.ServerStreamingServer[Blog]
