...
const file_proto_user_proto_rawDesc = "" +
	"\n" +
	"\x10proto/user.proto\x12\x04user\x1a\x1bgoogle/protobuf/empty.proto\"g\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x05Login\x12\x12.user.LoginRequest\x1a\x12.user.AuthResponse\x120\n" +
	"\n" +
	"GetProfile\x12\x16.google.protobuf.Empty\x1a\n" +
	".user.UserB\x05Z\x03/pbb\x06proto3"
...
var file_proto_user_proto_depIdxs = []int32{
	...
	4, // 3: user.UserService.GetProfile:input_type -> google.protobuf.Empty
	3, // 4: user.UserService.Register:output_type -> user.AuthResponse
	3, // 5: user.UserService.Login:output_type -> user.AuthResponse
	0, // 6: user.UserService.GetProfile:output_type -> user.User
